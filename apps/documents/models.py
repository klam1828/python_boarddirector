...
class Folder(MPTTModel):
    ...
    special_field = models.PositiveSmallIntegerField(_('special fields'), choices=SPECIAL_FIELDS, null=True, blank=True)
    ...
    class Meta:
        unique_together = (('parent', 'name'), ('account', 'special_field'),)
        ordering = ('name',)
