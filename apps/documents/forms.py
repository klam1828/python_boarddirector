...
class DocumentRenameForm(forms.Form):
    ...
    downloadable = forms.BooleanField(required=False)
...
class ShareAddForm(forms.Form):
    role = forms.ChoiceField(choices=[(0, _('Select ... ')),
                                      ...
                                      (Membership.ROLES.guest, _('All Board Staff/Guests'))])
    ...
    downloadable = forms.BooleanField(required=False, initial=False)
    ...
    def __init__(self, account, *args, **kwargs):
        ...
        # self.fields['downloadable'].initial = False
        # print(self.fields, self.fields['downloadable'].initial)
