...
class CommitteesView(ActiveTabMixin, SelectBoardRequiredMixin, CommitteeQuerysetMixin, GetMembershipMixin,
...
class CommitteeCreateView(CurrentAccountMixin, ActiveTabMixin, SelectBoardRequiredMixin, RecentActivityMixin,
                          CommitteeQuerysetMixin, PermissionMixin, LoginRequiredMixin, CreateView):
...
class CommitteeUpdateView(CurrentAccountMixin, ActiveTabMixin, SelectBoardRequiredMixin, RecentActivityMixin,
                          CommitteeQuerysetMixin, PermissionMixin, LoginRequiredMixin, UpdateView):
...
class CommitteeDetailView(ActiveTabMixin, SelectBoardRequiredMixin, CommitteeQuerysetMixin, PermissionMixin,
                          FolderContextMixin, LoginRequiredMixin, DetailView):
...
class CommitteeDeleteView(AjaxableResponseMixin, SelectBoardRequiredMixin,
                          CommitteeQuerysetMixin, PermissionMixin, LoginRequiredMixin, DeleteView):
