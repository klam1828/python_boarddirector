...
from common.mixins import ActiveTabMixin, SelectBoardRequiredMixin, LoginRequiredMixin
from meetings.models import Meeting, MeetingRepetition
from permissions import PERMISSIONS
from permissions.mixins import PermissionMixin


class CalendarView(ActiveTabMixin, SelectBoardRequiredMixin,
    ...
    def get_queryset(self):
        ...
        queryset = MeetingRepetition.objects.for_membership(
            membership, only_own_meetings=True).select_related('meeting', 'meeting__account')
