...
from common.mixins import AjaxableResponseMixin, SelectBoardRequiredMixin, ActiveTabMixin, LoginRequiredMixin
...
class NewsListView(SelectBoardRequiredMixin, NewsQuerysetMixin, PermissionMixin,
                   ActiveTabMixin, LoginRequiredMixin, ListView):
...
class NewsDetailView(SelectBoardRequiredMixin, NewsQuerysetMixin, PermissionMixin,
                     ActiveTabMixin, LoginRequiredMixin, DetailView):
    permission = (News, PERMISSIONS.view)
    template_name = 'news/news_detail.html'
    active_tab = 'news'


class NewsCreateView(SelectBoardRequiredMixin, PermissionMixin, FormValidMixin,
                     ActiveTabMixin, LoginRequiredMixin, CreateView):
...
class NewsUpdateView(SelectBoardRequiredMixin, NewsQuerysetMixin, PermissionMixin, FormValidMixin,
                     ActiveTabMixin, LoginRequiredMixin, UpdateView):
...
class NewsDeleteView(AjaxableResponseMixin, SelectBoardRequiredMixin, NewsQuerysetMixin,
