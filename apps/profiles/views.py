...
class MemberView(ActiveTabMixin, SelectBoardRequiredMixin, MembershipQuerysetMixin,
                 PermissionMixin, GetMembershipMixin, LoginRequiredMixin, DetailView):
...
class AssistantView(ActiveTabMixin, SelectBoardRequiredMixin, MembershipQuerysetMixin,
...
class InviteMemberView(AjaxableResponseMixin, SelectBoardRequiredMixin, PermissionMixin,
...
class EditProfileView(CurrentAccountMixin, CurrentMembershipMixin, MemberEditMixin, SelectBoardRequiredMixin,
                      MembershipQuerysetMixin, PermissionMixin, LoginRequiredMixin, FormView):
...
class MembershipDeleteView(AjaxableResponseMixin, SelectBoardRequiredMixin, MembershipQuerysetMixin,
                           PermissionMixin, LoginRequiredMixin, DeleteView):
...
class AssistantDeleteView(AjaxableResponseMixin, SelectBoardRequiredMixin, MembershipQuerysetMixin,
                          PermissionMixin, LoginRequiredMixin, DeleteView):
...
class LoginView(View):
    ...
    def login(self, *args, **kwargs):
        ...
        if not self.request.user.is_anonymous:
            memberships = self.request.user.membership_set\
                .filter(is_active=True)\
                .exclude(invitation_status=Membership.INV_INVITED)
