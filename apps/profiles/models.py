...
class Membership(models.Model):
    ...
    def get_path_to_discussion(self):
        return reverse('discussion:member', kwargs={'pk': self.id, 'url': self.account.url})

    def get_path_to_discussion_private(self):
        return reverse('discussion:member_private', kwargs={'pk': self.id, 'url': self.account.url})
