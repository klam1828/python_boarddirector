...
function reloadCheckboxes() {
    for (var q = 0; q < checkboxes.length; q++) {
        $(checkboxes[q]).siblings(".checkboxArea").remove();
        $(checkboxes[q]).siblings(".checkboxAreaChecked").remove();
        checkboxes[q].classList.remove("outtaHere");
        checkboxLabels[q].classList.remove("checkboxAreaCheckedLabel");
    }
