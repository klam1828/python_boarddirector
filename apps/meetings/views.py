...
from common.mixins import (ActiveTabMixin, CurrentAccountMixin, RecentActivityMixin,
                           ...
                           CurrentMembershipMixin, GetMembershipMixin, LoginRequiredMixin)
...
class MeetingsViewBase(MeetingTabMixin, ActiveTabMixin, SelectBoardRequiredMixin,
                       MeetingTypeMixin, MeetingsFilteredQuerysetMixin, PermissionMixin,
                       GetMembershipMixin, LoginRequiredMixin, ListView):
